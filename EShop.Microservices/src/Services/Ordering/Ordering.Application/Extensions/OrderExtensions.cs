...
public static class OrderExtensions
{
    public static IEnumerable<OrderDto> ToOrderDtoList(this IEnumerable<Order> orders)
    {
        return orders.Select(order => new OrderDto(
            ...
            PaymentMethod: new PaymentMethodDto(order.PaymentMethod.CardName!, order.PaymentMethod.CardNumber, order.PaymentMethod.Expiration, order.PaymentMethod.CVV, order.PaymentMethod.PaymentMethodType),
