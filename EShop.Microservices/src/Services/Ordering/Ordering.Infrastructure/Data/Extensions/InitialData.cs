...
internal class InitialData
{
    ...
    new List<Customer>
    {
        Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "Davood", "davood@gmail.com"),
        Customer.Create(CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")), "Neda", "neda@gmail.com")
    };
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("neda", "mo", "neda@gmail.com", "Bahcelievler No:4", "Turkey", "Istanbul", "38050");
            var address2 = Address.Of("davood", "ha", "davood@gmail.com", "Broadway No:1", "England", "Nottingham", "08050");

            var payment1 = PaymentMethod.Of("neda", "5555555555554444", "12/28", "355", 1);
            var payment2 = PaymentMethod.Of("davood", "8885555555554444", "06/30", "222", 2);
